    ...
    >
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h1 className="bg-gradient-to-b from-foreground to-foreground/70 bg-clip-text text-5xl font-bold text-transparent md:text-6xl">
          Build Your First AI App Without Becoming a Developer First
        </h1>

        {/* Subtitle */}
        <p className="mx-auto mt-6 max-w-2xl text-justify text-lg text-muted-foreground">
          A step-by-step course for founders, marketers, business analysts, and
          financial analysts who want to turn ideas into real software with AI.
          Learn how to plan, design, build, launch, and monetize useful apps using
          plain-English prompts, practical workflows, and short lessons.
        </p>
        ...
        <div className="mt-6 flex flex-wrap items-center justify-center gap-6 text-sm text-muted-foreground">
          ...
          <span className="flex items-center gap-1.5">
            <CircleCheck className="size-4 text-foreground/50" />
            Templates, source code, and real workflows
          </span>
        </div>
        ...
        <p className="mt-4 text-center text-xs text-muted-foreground/70">
          {waitlistOnly
            ? "Join the waitlist for early access, launch pricing, and product updates. No spam."
