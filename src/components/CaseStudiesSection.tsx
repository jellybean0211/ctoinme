...
const caseStudies = [
  {
    ...
    takeaway: "Time back. More billable hours. No new headcount needed.",
  ...
  },
  {
    ...
    takeaway: "Save the cost of a second hire. Your best people get rewarded more. Win-win.",
  ...
  },
  {
    ...
    takeaway: "Higher quality projects. Same cost. Just more effective.",
  ...
  },
  {
    ...
    takeaway: "Skip hiring developers or agencies. Build it yourself with AI.",
    ...
    <section id="results" className="w-full px-4 py-20">
      <div className="mx-auto max-w-4xl">
        <div className="mb-12 text-center">
          <span className="inline-block rounded-full bg-muted px-4 py-1 text-sm">Real Results</span>
          <h2 className="mt-4 text-3xl font-bold md:text-4xl">What Happens After the Workshop</h2>
          <p className="mx-auto mt-3 max-w-2xl text-muted-foreground">
            These are real people who went through our training. Here&apos;s what changed.
          </p>
        </div>
          ...
          {caseStudies.map((study) => (
            ...
            >
              <div className="mb-4 flex flex-wrap items-center gap-3">
                ...
                <span className="text-sm font-semibold">{study.name}</span>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div className="rounded-lg border border-border/50 bg-background/60 p-4">
                  ...
                  <p className="mt-2 text-sm text-muted-foreground">{study.before}</p>
                </div>
                <div className="rounded-lg border border-border/50 bg-background/60 p-4">
                  <p className="text-xs font-semibold uppercase tracking-[0.2em] text-emerald-400/70">
                    After
                  </p>
                  <p className="mt-2 text-sm text-muted-foreground">{study.after}</p>
                </div>
              </div>

              <p className="mt-4 text-sm font-medium text-foreground/80">{study.takeaway}</p>
            </div>
          ))}
        </div>

        <p className="mt-8 text-center text-xs text-muted-foreground/60">
          Names have been changed to protect the identities of those involved. All results are
          verified.
        </p>
      </div>
    </section>
